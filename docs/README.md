...
| [tools.md](tools.md) | what a tool is, the scope, what each would change, questions and answers, the pin, GPS from the places tag, GPS from the event, the offset of a date, the three date tools, the tag vocabulary, adding a tag, running tools together, the history and taking any pass back |
